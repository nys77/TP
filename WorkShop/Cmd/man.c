...
void man_echo()
{
    printf("ECHO(1)                   BSD General Commands Manual                  ECHO(1)\n");
    printf("\n");
    printf("NAME\n");
    ...
    printf("\n");
    printf("DESCRIPTION\n");
    printf("  The echo utility writes any specified operands, separated by single blank\n");
    printf("  (` ') characters and followed by a newline (`\n') character, to the stan-\n");
    printf("  dard output.\n");
    printf("\n");
    printf("  The following option is available:\n");
    printf("\n");
    printf("  -n    Do not print the trailing newline character.  This may also be\n");
    printf("        achieved by appending `\c' to the end of the string, as is done by\n");
    printf("        iBCS2 compatible systems.  Note that this option as well as the\n");
    printf("        effect of `\c' are implementation-defined in IEEE Std 1003.1-2001\n");
    printf("        (``POSIX.1'') as amended by Cor. 1-2002.  Applications aiming for\n");
    printf("        maximum portability are strongly encouraged to use printf(1) to\n");
    printf("        suppress the newline character.\n");
    printf("\n");
    printf("  Some shells may provide a builtin echo command which is similar or iden-\n");
    printf("  tical to this utility.  Most notably, the builtin echo in sh(1) does not\n");
    printf("  accept the -n option.  Consult the builtin(1) manual page.\n");
    printf("\n");
    printf("  EXIT STATUS\n");
    printf("  The echo utility exits 0 on success, and >0 if an error occurs.\n");
}
void man(char arg[])
{
    if (isEqual (arg,"ls"))
    ...
    else if (isEqual(arg,"exit"))
    {
        man_exit();
    }
    else if (isEqual(arg,"echo"))
    {
        man_echo();
    }
    else
